...
EXPECT_EXEMPT = {
    ...
    # `TRANSCRIPT.txt` (`meta/roadmap/0.1/0.1.4c.md`, TM-189).
    # THE CIVIL CROSS-ORACLE'S CORPUS -- cycle 0.1.4 (TM-181). A module of data,
    ...
    # O-N23'S DECLARING MODULE -- cycle 0.1.4c (TM-192). The table, the scalar,
...
def run_defect_corpus(rep, root, bld, subdir=None):
    ...
    reproductions their `expect-error:` markers (its fix landed, TM-189) and
    whose `fixed_import_scope/` (O-N23) brought seven asserted cases and one
    exempt declaring module (TM-192); 28 = 3 exempt + 25 asserted at compiler
