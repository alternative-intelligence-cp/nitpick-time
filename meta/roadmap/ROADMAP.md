...
| **0.1** | **The civil calendar** — the types, Hinnant's algorithms, the exhaustive sweep — **IN PROGRESS: 0.1.0 done; the adoption to compiler `c3bdae2` ([`0.1/0.1.0b.md`](0.1/0.1.0b.md)), the access properties ([`0.1/0.1.0c.md`](0.1/0.1.0c.md)) and the algorithms ([`0.1/0.1.1.md`](0.1/0.1.1.md)) planned execution-grade** | 0.0 ✓ |
